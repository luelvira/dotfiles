:PROPERTIES:
:HEADER-ARGS:emacs-lisp: :tangle (let ((org-use-tag-inheritance t)) (if (member "INACTIVE" (org-get-tags))  "no" "~/.emacs.d/init.el")))
:END:
...
Also I will change the location of the ~custom-file.el~
...
#+begin_src emacs-lisp
    ...
    (setq-default dispaly-line-numbers-width 5)
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'default-frame-alist '(family . "JetBrains Mono-10"))
#+end_src
...
Overwrite the completion at point shortcut of evil-mode
