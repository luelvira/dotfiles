:PROPERTIES:
:HEADER-ARGS:emacs-lisp: :tangle (let ((org-use-tag-inheritance t)) (if (member "INACTIVE" (org-get-tags))  "no" "config/emacs/init.el"))) :noweb tangle
:END:
...
- [[#general-configuration][General configuration]]
  ...
  - [[#dont-truncate-the-lines][Don't truncate the lines]]
- [[#theming][Theming]]
...
;; This file has been generated from <<metadata()>> file. DO NOT EDIT.
...
#+NAME: metadata
#+begin_src emacs-lisp :tangle no :noweb-ref metadata
(file-name-nondirectory (buffer-file-name))
#+end_src

#+NAME: lastexecution
#+begin_src emacs-lisp :tangle no :noweb-ref lastexecution
(format-time-string "Last generated on %c")
#+end_src
