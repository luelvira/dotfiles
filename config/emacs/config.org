...
(provide 'lem-doom-theme)
#+end_src

*** Color theme with other themes
#+begin_src emacs-lisp
...
[[https://github.com/victorteokw/emacs-anzu][Anzu]] is a port of [[https://github.com/osyo-manga/vim-anzu][vim-anzu]], which provides a minor mode to display /current match/ and /total matches/ in the modeline.
...
:PROPERTIES:
:HEADER-ARGS:emacs-lisp+: :tangle modules/lem-vertico.el
:END:
...
:PROPERTIES:
:HEADER-ARGS:emacs-lisp+: :tangle modules/lem-dired.el
:END:
#+begin_src emacs-lisp
<<header>>
#+end_src
