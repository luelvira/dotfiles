...
- [[#general-configuration][General configuration]]
  ...
  - [[#disable-warnings-when-native-compilation][Disable warnings when native compilation]]
  - [[#recovery][Recovery]]
  - [[#history][History]]
  - [[#confirmation-prompts][Confirmation prompts]]
  - [[#defaults][Defaults]]
  - [[#set-up-tramp][Set up tramp]]
  ...
  - [[#enable-scape-instead-of-c-g][Enable scape instead of C-g]]
...
- [[#lem-module][lem module]]
  ...
  - [[#define-the-key-bindings][Define the key bindings]]
  - [[#reload-emacs][Reload emacs]]
  - [[#define-the-key-bindings-1][Define the key bindings]]
- [[#theming][Theming]]
...
- [[#writing][Writing]]
  ...
  - [[#zen-mode][zen mode]]
  - [[#latex][Latex]]
  - [[#end-of-write-module][End of Write module]]
- [[#org-mode][Org mode]]
...
- [[#org-roam][Org roam]]
  ...
  - [[#combining-org-roam-with-markdown-syntax][Combining org roam with markdown syntax!]]
- [[#denote][Denote]]
...
;; author: Lucas Elvira <lucaselvira96@gmail.com>
;; Version: 0.0.1
;; Package-Requires: ((flyspell) (langtool) (visual-fill-column) (auctex) (cdlatex))
...
#+begin_src emacs-lisp
  ...
  (defmacro inc (var)
    ...
    `(setq ,var (mod (+ 1 ,var) (length lem/dictionaries-list))))
  ...
  (defun lem-write/switch-dictionary ()
    ...
    (let* ((dic ispell-current-dictionary)
            (change (nth (inc lem/dictionaries-pos) lem/dictionaries-list)))
