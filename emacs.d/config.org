...
- [[#restart-the-dashboard][Restart the dashboard]]
...
#+begin_src emacs-lisp
  ...
  "fe" '((lambda () (interactive) (counsel-find-file "~/Documents/git/dotfiles/emacs.d/")) :which-key "Emacs Config")
...
After load all the config, I want to see the dashboard updated
#+begin_src emacs-lisp
(dashboard-open)
#+end_src
