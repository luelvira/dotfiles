...
(defcustom lem/icons-completion-function
:group 'lem
:type '(symbol))
#+end_src
...
completions for the prefix. For example, if you press =C-c= (hold control and press the letter =c=), a panel will appear at
the bottom of the frame displaying all of the bindings under that prefix and which command they run. This is very useful
...
(lem/leader-key-def
  ...
  "tz" '(writeroom-mode          :which-key "Reduce number of items in the interface.")
...
For the [[help:consult-goto-line][consult-goto-line]] and ~consult-line~ commands, we define our owns with live preview (independently of the
[[help:consult-preview-key][consult-preview-key]]) ([[https://github.com/rougier/dotemacs/blob/37a22e94b39bc0c2965c40b3ec331438f04d1efe/dotemacs.org?plain=1#L2007][Example from rougier]])
...
(use-package marginalia
  ...
  :hook (marginalia-mode . lem/icons-completion-function)
  :config
...
[[https://github.com/oantolin/orderless][Orderless]] improves candidate filtering create pattern by words separate with
...
(use-package writeroom-mode
  :disabled t
  :hook ((writeroom-mode-enable  . (lambda () (display-line-numbers-mode 0)))
