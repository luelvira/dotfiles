...
** List of package to be installed                                 :INACTIVE:
:PROPERTIES:
...
#+begin_src emacs-lisp
  ...
  (defcustom lem-fixed "FiraCodeNerdFont"
    ...
    :type '(string)
    :group 'lem)
  (defcustom lem-default "Monospace"
...
** Presentations
Org allows you to export the content and create a custom presentation views. In this section I will test [[https://github.com/hakimel/reveal.js][reveal.js]] and [[https://github.com/yjwen/org-reveal][org-reveal]].

*** Revel.js

Is an FOSS html presentation framework with a powerful feature set. The author suggests you to download the full version by npm or git
...
This is a module that enables you to export an org-file to reveal.js, so it does not need the full config. I can download the zip and include the files associated while export.

#+begin_src emacs-lisp
(use-package org-reveal
  :defer t
  :config
  (setq org-reveal-root "file:///home/lucas/.cache/emacs/reveal/reveal.js-master"))
#+end_src
